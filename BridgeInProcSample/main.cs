...
namespace RotatingCube
{
    ...
    public class MainWindow : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            // mlc: init bridge
            if (!BridgeInProc.Controller.Initialize(@"BridgeInProcSample"))
            {
                Environment.Exit(-1);
            }
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            //BridgeInProc.Controller.SaveTextureToFileGL(_bridge_window, @"C:\\temp\\quilt_gl.png", (ulong)_bridge_render_texture, BridgeInProc.PixelFormats.RGBA, _bridge_render_texture_width, _bridge_render_texture_height);
