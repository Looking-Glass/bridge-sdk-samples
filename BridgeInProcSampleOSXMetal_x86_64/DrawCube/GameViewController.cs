...
namespace DrawCube
{
    public partial class GameViewController : NSViewController, IMTKViewDelegate
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            if (!BridgeInProc.Controller.InitializeWithPath(@"BridgeInProcSampleOSX", "/Users/matty/git/LookingGlassBridge/build/LookingGlassBridge.app/Contents/MacOS"))
            {
                Environment.Exit(-1);
            }

            // mlc: instance the window
            bool window_status = BridgeInProc.Controller.InstanceWindowMetal(device.Handle, ref _bridge_window);
            ...
            BridgeInProc.Controller.CreateMetalTextureWithIOSurface(_bridge_window, textureDescriptor.Handle, out metalTexturePtr);
        ...
        public void Draw(MTKView view)
        {
            ...
            BridgeInProc.Controller.CopyMetalTexture(_bridge_window, _renderTexture.Handle, _renderTexture.Handle);

            //BridgeInProc.Controller.SaveMetalTextureToFile(_bridge_window, @"/Users/matty/rendertarget.png", _renderTexture.Handle, PixelFormats.RGBA, _bridge_render_texture_width, _bridge_render_texture_height);

            BridgeInProc.Controller.DrawInteropQuiltTextureMetal(_bridge_window, _renderTexture.Handle, _bridge_quilt_vx, _bridge_quilt_vy, 1.0f, 1.0f);
        }
