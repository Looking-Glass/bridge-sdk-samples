...
namespace DX12GameProgramming
{
    ...
    internal class BoxApp : D3DApp
    {
        ...
        public BoxApp()
        {
            MainWindowCaption = "Bridge SDK C# DX12 Sample";
        }
        ...
        public override void Initialize()
        {
            ...
            // mlc: init bridge
            if (!BridgeSDK.Controller.Initialize(@"BridgeSDKSampleDX12"))
            {
                Environment.Exit(-1);
            }
        ...
        protected override void Draw(GameTimer gt)
        {
            ...
            BridgeSDK.Controller.DrawInteropQuiltTextureDX(_bridge_window, _quiltRenderTarget.NativePointer, _bridge_quilt_vx, _bridge_quilt_vy, 1.0f, 1.0f);
            //BridgeSDK.Controller.SaveTextureToFileDX(_bridge_window, @"C:\\temp\\quilt.png", _quiltRenderTarget.NativePointer);
        ...
        bool SaveRenderTargetToFile(SharpDX.Direct3D12.Resource resource, string filename)
        {
            ...
            BridgeSDK.Controller.SaveImageToFile(_bridge_window, filename, mappedDataPointer, BridgeSDK.PixelFormats.RGBA, (ulong)resource.Description.Width, (ulong)resource.Description.Height);
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                BridgeSDK.Controller.UnregisterTextureDX(_bridge_window, _quiltRenderTarget.NativePointer);
