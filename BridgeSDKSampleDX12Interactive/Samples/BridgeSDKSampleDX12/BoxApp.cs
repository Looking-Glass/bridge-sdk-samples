...
namespace DX12GameProgramming
{
    ...
    internal class BoxApp : D3DApp
    {
        ...
        public override void Initialize()
        {
            ...
            // mlc: init bridge
            if (!BridgeSDK.Controller.Initialize(@"BridgeSDKSampleDX12Interactive"))
            {
                Environment.Exit(-1);
            }

            // mlc: instance the window
            bool window_status = BridgeSDK.Controller.InstanceOffscreenWindowDX(Device.NativePointer, ref _bridge_window);
        ...
        protected override void Draw(GameTimer gt)
        {
            ...
            if (_lkg_display)
            {
                ...
                if (_bridge_offscreen_texture == null)
                {
                    ...
                    if (BridgeSDK.Controller.GetOffscreenWindowTextureDX(_bridge_window, out nativeTexturePtr))
                    {
