...
namespace RotatingCube
{
    ...
    public class MainWindow : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            if (!BridgeSDK.Controller.Initialize(@"BridgeSDKSampleOSX"))
            {
                Environment.Exit(-1);
            }
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            //BridgeSDK.Controller.SaveTextureToFileGL(_bridge_window, @"/Users/matty/quilt.png", (ulong)_bridge_render_texture, BridgeSDK.PixelFormats.RGBA, _bridge_render_texture_width, _bridge_render_texture_height);
